...
<div class="relative">
  ...
  <textarea
    id={name}
    class="border bg-gray-50 rounded-xl w-full h-40 mt-2 italic p-2 text-sm focus:outline-none focus:ring-1 focus:ring-community-300 focus:border-transparent {errorMessage
