...
use Proximum\Vimeet365\Admin\Application\Command\Community\SetMatchingGoalsCommandHandler;
...
class SetMatchingGoalsCommandHandlerTest extends TestCase
{
    ...
    public function testRemove(): void
    {
        ...
        new Community\GoalMatching($goal, $tagA->reveal(), $tagB->reveal(), 1);
    ...
    public function testChangePriority(): void
    {
        ...
        new Community\GoalMatching($goal, $tagA->reveal(), $tagB->reveal(), 0);
        new Community\GoalMatching($goal, $tagA->reveal(), $tagC->reveal(), 1);
